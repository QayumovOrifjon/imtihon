...
import Kabinet from "../Hero/Kabinet";
import Section from "../Hero/Section";
import Tovar from "../Hero/Tovar";
import Brend from "../../ui/Brend";
import Kompaniye from "../Hero/Kompaniye";
import Email from "../Email/Email";
import Footer from "../Footer.jsx/Footer";
import Form from "../../ui/Form";
import Brends from "../Hero/Brends";
...
const ProductCategory = () => {
  ...
  return (
    ...
    <Header/>
      ...
      <div className="flex pt-5  mb-5 gap-2 container mt-[220px]">
        <p
          onClick={breadcast}
          className="text-[#7A7687] text-[14px] font-normal leading-[normal] cursor-pointer"
        >
          Главная {">"}
        </p>
        <span
        ...
        <span className="text-[#202020] text-[14px] font-normal leading-[normal]">
