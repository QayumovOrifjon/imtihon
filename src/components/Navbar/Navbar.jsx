...
const Navbar = () => {
  ...
  return (
  <>
        <div className="bg-[#F8F7F3] px-[35px] z-30 fixed w-full"> 
          <div className="flex justify-between py-2.5 container "> 
            <ul className="flex gap-5">
              ...
              <p className="text-[12px] cursor-pointer hover:text-[#088269] hover:scale-105 duration-200 "> <NavLink to='/Vakansiya'>Вакансии</NavLink></p>
              <p className="text-[12px] cursor-pointer hover:text-[#088269] hover:scale-105 duration-200 "><NavLink to='/Otziv'>Отзывы</NavLink></p>
              <p className="text-[12px] cursor-pointer hover:text-[#088269] hover:scale-105 duration-200 "><NavLink to='/Sertifikati'>Сертификаты  </NavLink></p>
              <p className="text-[12px] cursor-pointer hover:text-[#088269] hover:scale-105 duration-200 ">Партнерские программы</p>
              <p className="text-[12px] cursor-pointer hover:text-[#088269] hover:scale-105 duration-200 ">Оптовые продажи</p>
              <p className="text-[12px] cursor-pointer hover:text-[#088269] hover:scale-105 duration-200 ">Лизинг</p>
            </div>
          </li>
